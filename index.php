...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9730547746</li>	
					<li class="s-bar">
						<div class="search">
							<a href="login.php">
							<label class="icon-search" for="search_box"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></label>
							</a>
						</div>
					</li>
				</ul>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="register.php"><h2>ROOM RESERVATION</h2></a>
</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Sunrise Hotel is well built and well maintained hotel. Attraction of this hotel is, it is near sea shore which give a magnificient view from Rooms. <br>Also Sunrise has certification of world class Hospitality.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>We offer the best Amenities</p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
					...
					<ul class="slides">
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								Rating:<?php echo $row['rating'];?><i class="fa fa-star" aria-hidden="true"></i>
								</h4>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9730547746</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Gass Kandok No 1, Vasai(W)</p>
		...
		<iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Gass Kandok &t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
